...
class RouteMapViewController: UIViewController {
    ...
    public var navigationView: NavigationView { view as! NavigationView }
    public var mapView: NavigationMapView { self.navigationView.mapView }
    public var statusView: StatusView { self.navigationView.statusView }
    public var lanesView: LanesView { self.navigationView.lanesView }
    public var nextBannerView: NextBannerView { self.navigationView.nextBannerView }
    public var instructionsBannerView: InstructionsBannerView { self.navigationView.instructionsBannerView }
    public var instructionsBannerContentView: InstructionsBannerContentView { self.navigationView.instructionsBannerContentView }
    public var route: Route? { self.routeController?.routeProgress.route }
