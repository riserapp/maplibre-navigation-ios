...
open class NavigationViewController: UIViewController {
    ...
    public var navigationView: NavigationView {
        mapViewController.navigationView
    }
...
extension NavigationViewController: RouteMapViewControllerDelegate {
    ...
    open func handleCancelButtonPress() {
        self.endNavigation()
...
extension NavigationViewController: RouteControllerDelegate {
    ...
    @objc
    open func routeController(_ routeController: RouteController, didRerouteAlong route: Route, reason: RouteController.RerouteReason) {
        self.mapViewController.notifyDidReroute(route: route)
